...
bool Generator::verifyGridStatus() { return grid_status; }
...
void Generator::generate(int board[GRID_SIZE][GRID_SIZE]) {
    ...
    std::copy(&puzzle->grid[0][0], &puzzle->grid[0][0] + GRID_SIZE * GRID_SIZE, &board[0][0]);
